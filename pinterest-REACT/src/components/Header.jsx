  ...
  return (
    <div css={headerDivCss}>
      <a href="/temp" css={profileButtonsCss}>
        <img
          src="https://icon-library.com/images/notification-bell-icon/notification-bell-icon-6.jpg"
          height="25"
          width="25"
        ></img>
      </a>
      ...
      <a css={profileButtonsCss} onClick={() => history.push('/accounts')}>
        <img
          src="https://i.pinimg.com/originals/5f/64/17/5f6417000d38033f6443f0bc3d1c67c8.jpg"
          width="25"
          height="25"
          css={{borderRadius: '50%'}}
        ></img>
